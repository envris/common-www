...
switch($search->site)
{
  ...
  case "harbourtrust.gov.au":
    ...
    $SearchAgainPage = "search.php";
    $PublicationsSearchString = "/downloads/";
  break;
  ...
  case "sustainability.gov.au":
    define("THEME", "sustainability");
    $search->theme = "sustainability";
    $search->cur_site_area_theme = "sustainability";
    $search->show_pub_search_again = "yes";
    $search->show_search_heritage_portal = "no";
    $search->show_search_environment_portal = "yes";
    $search->show_search_arts_portal = "no";
    $search->show_search_australia_gov = "yes";
    $siteArea = "sustainability";
    $RadioText = "Sustainability";
    $SearchAgainPage = "search.php";
    $PublicationsSearchString = "/publications/";
  break;
  ...
  break;
    ...
    case "www.yourhome.gov.au":
    define("THEME", "deh");
    $search->theme = "deh";
    $search->cur_site_area_theme = "deh";
    $search->url_limit_string = "www.yourhome.gov.au";
    $search->show_pub_search_again = "no";
    $search->show_search_heritage_portal = "no";
    $search->show_search_environment_portal = "no";
    $search->show_search_arts_portal = "no";
    $search->show_search_australia_gov = "no";
    $siteArea = "yourhome";
    $SearchAgainPage = "search.php";
    $PublicationsSearchString = "/publications/";
  break;

  case "climatechange.gov.au":
    define("THEME", "deh");
    $search->theme = "greenhouse";
    $search->cur_site_area_theme = "greenhouse";
    $search->url_limit_string = "climatechange.gov.au";
    $search->show_pub_search_again = "no";
    $search->show_search_heritage_portal = "no";
    $search->show_search_environment_portal = "no";
    $search->show_search_arts_portal = "no";
...
//}
  ...
  {
    $a_href = "http://www.arts.gov.au/search?query=" . urlencode($search->query);
  } else {
  ...
  //End Publications Only
        ...
        if (count($search->results) > 0) {
          ...
          for ($i = 0; $i < count($search->results); $i++) {
            if($search->results[$i]->title == "http://www.weeds.gov.au/searchdb.xml")
            {
