<?php
   ...
   *    <?php include '../includes/php/funnelback2.php'; ?>
   *
   *
   */
...
if ($isPublicationsSearch == "True")
{
 ...
 // print $siteArea;
  switch($siteArea)
  {
    ...
    case "commitments":
      define("THEME", "commitments");
      define("PROFILE", "about");
      $PublicationType = "Activities and Commitments";
      $RadioText = "Activities and Commitments";
      break;
    ...
    case "esd":
      define("THEME", "esd");
      define("PROFILE", "esd");
      $PublicationType = "<acronym title=\"Ecologically Sustainable Development\">ESD</acronym>";
      $RadioText = "Ecologically Sustainable Development";
      break;

    case "events":
      define("THEME", "events");
      define("PROFILE", "about");
      $PublicationType = "Calendar";
      $RadioText = "Environmental Events Calendar 2006";
      break;
    ...
    case "jobs":
      define("THEME", "jobs");
      define("PROFILE", "about");
      $PublicationType = "Employment";
      $RadioText = "Employment Opportunities";
      break;
    ...
    case "water":
      ...
      $PublicationType = "Inland Waters";
      $RadioText = "Inland Waters";
      break;

    case "deh":
      define("THEME", "deh");
      define("PROFILE", "deh");
      $PublicationType = "<acronym title=\"Department of the Environment and Water Resources\">DEW</acronym>";
      $RadioText = "";//No Radio button for this one so leave blank
      break;
  ...
  $a_href = "";
  $search->query = "";
  //if (isset($_GET["query"])) $search->query = htmlspecialchars($_GET["query"], ENT_QUOTES);
...
<?php
  ...
  if($search->theme == "deh")
  {
    writeThemeRadioButton("deh", "True", "<acronym title=\"Department of the Environment and Water Resources\">DEW</acronym>");
  } else {
    writeThemeRadioButton("deh", "", "<acronym title=\"Department of the Environment and Water Resources\">DEW</acronym>");
  }
